...
//Initial WGDC
#define ORIG_TABLE_INIT_WGDC_ADDRESS (0x00059844)
...
//Max WGDC
#define ORIG_TABLE_MAX_WGDC_ADDRESS (0x0005987C)
...
#define ORIG_TABLE_PRIMARY_OL_A_ADDRESS (0x0005AC04)
...
//Intake AVCS
#define ORIG_TABLE_INTAKE_AVCS_A_ADDRESS (0X0005BF10)

#define TABLE_INTAKE_AVCS_X_COUNT 14
...
#define ORIG_TABLE_TARGET_THROTTLE_POSITION_A_ADDRESS (0x0005BA38)
