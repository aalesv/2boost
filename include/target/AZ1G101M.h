...
//Initial WGDC
#define ORIG_TABLE_INIT_WGDC_ADDRESS (0x84C54)
...
//Max WGDC
#define ORIG_TABLE_MAX_WGDC_ADDRESS (0x84C38)
...
#define ORIG_TABLE_PRIMARY_OL_A_ADDRESS (0x8706C)
...
//Base Timing
#define ORIG_TABLE_BASE_TIMING_A_ADDRESS (0x87D14) //Base Timing Primary Cruise
#define ORIG_TABLE_BASE_TIMING_B_ADDRESS (0x87D30) //Base Timing Primary Non-Cruise
#define ORIG_TABLE_BASE_TIMING_C_ADDRESS (0x87D4C) //Base Timing Reference Cruise (AVCS related)
#define ORIG_TABLE_BASE_TIMING_D_ADDRESS (0x87D68) //Base Timing Reference Non-Cruise (AVCS related)
...
//Intake AVCS
#define ORIG_TABLE_INTAKE_AVCS_A_ADDRESS (0x89094) //Intake Cam Advance Angle Cruise
#define ORIG_TABLE_INTAKE_AVCS_B_ADDRESS (0x890B0) //Intake Cam Advance Angle Non-Cruise
...
#define ORIG_TABLE_TARGET_THROTTLE_POSITION_A_ADDRESS (0x000889A8) //Target Throttle Plate Position Cruise
#define ORIG_TABLE_TARGET_THROTTLE_POSITION_B_ADDRESS (0x000889C4) //Target Throttle Plate Position Non-Cruise
...
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_A_ADDRESS (0x00086D6C)
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_B_ADDRESS (0x00086D80)
...
//MAF table address
#define ORIG_TABLE_MAF_ADDRESS (0x00088BDC)
