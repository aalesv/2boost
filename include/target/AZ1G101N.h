...
//Target Boost
#define ORIG_TABLE_TARGET_BOOST_ADDRESS (0x00084C70)
...
//Initial WGDC
#define ORIG_TABLE_INIT_WGDC_ADDRESS (0x00084C54)
...
//Max WGDC
#define ORIG_TABLE_MAX_WGDC_ADDRESS (0x00084C38)
...
#define ORIG_TABLE_PRIMARY_OL_A_ADDRESS (0x00087074)
...
//Base Timing
#define ORIG_TABLE_BASE_TIMING_A_ADDRESS (0x00087D1C) //Base Timing Primary Cruise
#define ORIG_TABLE_BASE_TIMING_B_ADDRESS (0x00087D38) //Base Timing Primary Non-Cruise
#define ORIG_TABLE_BASE_TIMING_C_ADDRESS (0x00087D54) //Base Timing Reference Cruise (AVCS related)
#define ORIG_TABLE_BASE_TIMING_D_ADDRESS (0x00087D70) //Base Timing Reference Non-Cruise (AVCS related)
...
//Intake AVCS
#define ORIG_TABLE_INTAKE_AVCS_A_ADDRESS (0x0008909C) //Intake Cam Advance Angle Cruise
#define ORIG_TABLE_INTAKE_AVCS_B_ADDRESS (0x000890B8) //Intake Cam Advance Angle Non-Cruise
...
#define ORIG_TABLE_TARGET_THROTTLE_POSITION_A_ADDRESS (0x000889B0) //Target Throttle Plate Position Cruise
#define ORIG_TABLE_TARGET_THROTTLE_POSITION_B_ADDRESS (0x000889CC) //Target Throttle Plate Position Non-Cruise
...
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_A_ADDRESS (0x00086D74)
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_B_ADDRESS (0x00086D88)
...
//Tip-in routine
#define P_THROTTLE_ANGLE_CHANGE_ADDRESS (0xFFFF6510)
...
//Cruise state
#define P_CRUISE_STATE_ADDRESS (0xFFFF61FA) /* Cruise system flag variable RAM address */
...
//SSM Routine S154
#define P_CRUISE_CANCEL_SWITCH_ADDRESS (0xFFFF6206)
...
//SSM Routine P30
#define P_ACCELERATOR_PEDAL_ANGLE_ADDRESS (0xFFFF66E0)
#define P_ACCELERATOR_PEDAL_ANGLE ((float *)P_ACCELERATOR_PEDAL_ANGLE_ADDRESS)

//Brake pedal switch
//SSM Routine S67
#define P_BRAKE_PEDAL_SWITCH_ADDRESS (0xFFFF61F4)
...
#define ORIG_CEL_TRIGGER_OUTER_FUNCTION_ADDRESS (0x0007A866)
//ROM CEL status
#define P_CEL_LIGHT_STATUS_OEM_ADDRESS (0xFFFF997E)
#define P_CEL_LIGHT_STATUS_OEM ((unsigned char*)P_CEL_LIGHT_STATUS_OEM_ADDRESS)

//Engine load, E32
#define P_ENGINE_LOAD_ADDRESS (0xFFFF6610)
#define P_ENGINE_LOAD ((float*)P_ENGINE_LOAD_ADDRESS)

//FBKC, E39
#define P_FBKC_ADDRESS  (0xFFFF7C60)
