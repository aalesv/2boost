...
*
*2Boost is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation, either version 3 of the License, or () any later version.
*
*This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details.
*/

#define CALID "ZA1JB00C"
...
//Data  - uint only.
//Converts to float.
#define ORIG_CALC_3D_UINT_TO_FLOAT_FUNCTION_ADDRESS (0x00011420)

//Calc 2D function ROM address.
//X     - float
//Data  - float only.
//No conversion, returns float
#define ORIG_CALC_2D_FLOAT_TO_FLOAT_FUNCTION_ADDRESS (0x0001139C)
...
#define ORIG_TABLE_PRIMARY_OL_A_ADDRESS (0x000CD9E4)
...
//Base Timing
#define ORIG_TABLE_BASE_TIMING_A_ADDRESS (0x000CEE00) //Base Timing Primary Cruise
#define ORIG_TABLE_BASE_TIMING_B_ADDRESS (0x000CEE1C) //Base Timing Primary Non-Cruise
...
//Intake AVCS
#define ORIG_TABLE_INTAKE_AVCS_A_ADDRESS (0x000D1004) //Intake Cam Advance Angle Normal
...
//Exhaust AVCS
#define ORIG_TABLE_EXHAUST_AVCS_A_ADDRESS (0x000D10AC) //Exhaust Cam Advance Angle Normal
...
//Requested Torque ()
#define ORIG_TABLE_REQUESTED_TORQUE_ACCELERATOR_PEDAL_A_ADDRESS (0x000CA3B0) //Requested Torque (Accelerator Pedal) Cruise
#define ORIG_TABLE_REQUESTED_TORQUE_ACCELERATOR_PEDAL_B_ADDRESS (0x000D0138) //Requested Torque (Accelerator Pedal) Non-Cruise
...
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_A_ADDRESS (0x000CD19C)
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_B_ADDRESS (0x000CD1B0)
...
//MAF table address
#define ORIG_TABLE_MAF_ADDRESS (0x000D08B4)
...
//SSM Routine P8
#define P_ENGINE_SPEED_ADDRESS (0xFFF893F8)
//Engine speed, RPM
...
//Cruise state
#define P_CRUISE_STATE_ADDRESS (0xFFF89392) /* Cruise system flag variable RAM address */
...
//SSM Routine P30
#define P_ACCELERATOR_PEDAL_ANGLE_ADDRESS (0xFFF8914C)
