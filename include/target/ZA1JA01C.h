...
#define ORIG_TABLE_PRIMARY_OL_A_ADDRESS (0x000CD690)
...
//Base Timing
#define ORIG_TABLE_BASE_TIMING_A_ADDRESS (0x000CEAAC) //Base Timing Primary Cruise
#define ORIG_TABLE_BASE_TIMING_B_ADDRESS (0x000CEAC8) //Base Timing Primary Non-Cruise
...
//Intake AVCS
#define ORIG_TABLE_INTAKE_AVCS_A_ADDRESS (0x000D0CB0) //Intake Cam Advance Angle Normal
...
//Exhaust AVCS
#define ORIG_TABLE_EXHAUST_AVCS_A_ADDRESS (0x000D0D58) //Exhaust Cam Advance Angle Normal
...
//Requested Torque ()
#define ORIG_TABLE_REQUESTED_TORQUE_ACCELERATOR_PEDAL_A_ADDRESS (0x000CA07C) //Cruise
#define ORIG_TABLE_REQUESTED_TORQUE_ACCELERATOR_PEDAL_B_ADDRESS (0x000C9AB8) //Non-Cruise
...
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_A_ADDRESS (0x000CCE54)
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_B_ADDRESS (0x000CCE68)
...
//MAF table address
#define ORIG_TABLE_MAF_ADDRESS (0x000D0560)
