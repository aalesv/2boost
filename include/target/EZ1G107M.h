...
#define ORIG_TABLE_PRIMARY_OL_A_ADDRESS (0x0007A55C)
#define ORIG_TABLE_PRIMARY_OL_B_ADDRESS (0x0007A578)

#define TABLE_PRIMARY_OL_X_COUNT 11
#define TABLE_PRIMARY_OL_Y_COUNT 10
...
//Base Timing
#define ORIG_TABLE_BASE_TIMING_A_ADDRESS (0x0007AFF0) //Base Timing Primary Cruise
#define ORIG_TABLE_BASE_TIMING_B_ADDRESS (0x0007B00C) //Base Timing Primary Non-Cruise
#define ORIG_TABLE_BASE_TIMING_C_ADDRESS (0x0007B028) //Base Timing Reference Cruise (AVCS related)
#define ORIG_TABLE_BASE_TIMING_D_ADDRESS (0x0007B044) //Base Timing Reference Non-Cruise (AVCS related)

#define TABLE_BASE_TIMING_X_COUNT 14
...
#define ORIG_TABLE_TARGET_THROTTLE_POSITION_A_ADDRESS (0x0007BAB8) //Target Throttle Plate Position Cruise
#define ORIG_TABLE_TARGET_THROTTLE_POSITION_B_ADDRESS (0x0007BAD4) //Target Throttle Plate Position Non-Cruise

#define TABLE_THROTTLE_POSITION_X_COUNT 28
#define TABLE_THROTTLE_POSITION_Y_COUNT 20
...
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_A_ADDRESS (0x0007A280)
#define ORIG_TABLE_THROTTLE_TIP_IN_ENRICHMENT_B_ADDRESS (0x0007A294)
...
//Cruise state
#define P_CRUISE_STATE_ADDRESS (0xFFFF607E) /* Cruise system flag variable RAM address */
...
//SSM Routine S154
#define P_CRUISE_CANCEL_SWITCH_ADDRESS (0xFFFF608A)
...
//SSM Routine P30
#define P_ACCELERATOR_PEDAL_ANGLE_ADDRESS (0xFFFF651C)
#define P_ACCELERATOR_PEDAL_ANGLE ((float *)P_ACCELERATOR_PEDAL_ANGLE_ADDRESS)

//Brake pedal switch
//SSM Routine S67
#define P_BRAKE_PEDAL_SWITCH_ADDRESS (0xFFFF6078)
...
#define ORIG_CEL_TRIGGER_OUTER_FUNCTION_ADDRESS (0x0006E4DA)
//ROM CEL status
#define P_CEL_LIGHT_STATUS_OEM_ADDRESS (0xFFFF9642)
#define P_CEL_LIGHT_STATUS_OEM ((unsigned char*)P_CEL_LIGHT_STATUS_OEM_ADDRESS)

//Engine load, E32
#define P_ENGINE_LOAD_ADDRESS (0xFFFF64A0)
#define P_ENGINE_LOAD ((float*)P_ENGINE_LOAD_ADDRESS)

//FBKC, E39
#define P_FBKC_ADDRESS  (0xFFFF7E28)
